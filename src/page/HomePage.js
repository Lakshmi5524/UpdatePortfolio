    ...
    <HomePageStyled>
      ...
      <div className="typography">
        ...
        <p>
          ...
          where it all began from blank screens to beautiful websites/web
          application nowadays and that's how far I have grown now. I Love to
          create full stack applications using MERN stack preferably.
        </p>
        <p>
          Intended to structure my growth in pace with the ever-changing
          corporate environment. Make my learning curve to move in a linear
          fashion along with the growth of functional skills coupled with
          overall personality development to face the challenging times ahead
        </p>

        <div className="icons">
          <a
            href="https://github.com/Lakshmi5524"
            target="_blank"
